...
dt <- fread('data/storm_calamities.csv')
...
output$populationImpact <- renderChart({
        ...
        populationImpact$yAxis( axisLabel = "Affected", width = 100)
        populationImpact$xAxis( axisLabel = "Year", width = 85)
...
output$economicImpact <- renderChart({
        ...
        economicImpact$yAxis( axisLabel = "Total damage (Million USD)", width = 180)
        economicImpact$xAxis( axisLabel = "Year", width = 150)
